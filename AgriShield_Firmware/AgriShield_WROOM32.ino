...
#define DS18B20_PIN 18       // DS18B20 soil temperature
#define SOIL_MOISTURE_PIN 34 // Analog pin for capacitive sensor
#define BATTERY_PIN 35       // Analog pin for battery voltage
